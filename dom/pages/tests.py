...
class MyTest(TestCase):
    ...
    #     form_data={"username":"azeez","email":"azeezokhamena@gmail.com","password1":"failfault","password2":"failfault"}
    ...
    def test_if_signin_url_is_working(self):
        response = self.client.get(reverse(view1))
        self.assertEqual(response.status_code,200)
        self.assertTemplateUsed(response,"account/signin.html")
    
    
    def test_if_used_form_data_is_correct(self):
        myform =MyForm({"name": "azeez", "message": "This is the townhall",
                      "email": "azeezokhamena@gmail.com"})
        contact = Contactform({"username": "okhamena",
                     "email": "azeezokhamena@gmail.com",
                     "password1": "failfault",
                     "password2": "failfault"
                     })
    ...
    def test_If_the_url_Of_pricing_is_working(self):
        response = self.client.get(reverse("pricing"))
        self.assertEqual(response.status_code,200)
        self.assertTemplateUsed(response,"pages/pricing.html","pages/base.html")
